    ...
    <main class="main">
        <section class="topArea individual position-relative">
            ...
            <div class="position-absolute text-center w-100">
                <div class="display-3 fw-bold text-white">Therapy for Women in Michigan</div>
        ...
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-md-9">
                        <div class="mx-auto">
                            <h1>Mental Health Care for Women at Every Stage of Life</h1>

                            <p class="lead">Healing Therapy Center provides therapy designed around the realities of women's lives — the invisible workload, the career pressure, the hormonal transitions, the expectation to hold everything together. Our clinicians specialize in women's mental health, with in-person care in Dearborn and telehealth throughout Michigan.</p>
                            ...
                            <div class="alert alert-success mb-4" data-aos="fade-up">
                                <h3 class="h5 mb-3"><i class="bi bi-heart-fill me-2"></i>Care Designed for Women</h3>
                                <ul class="mb-2">
                                    <li><strong>Women's Mental Health Specialists:</strong> <a href="donna-majed" class="alert-link">Donna Majed, TLLP</a> specializes in women's mental health; <a href="dr-tiffany-murray" class="alert-link">Tiffany Murray, LMSW</a> is trained in perinatal mood and anxiety disorders</li>
                                ...
                                <p class="small mb-0"><strong>Call <a href="tel:313-654-1915" class="alert-link">(313) 654-1915</a></strong> to schedule your first appointment.</p>
                            </div>

                            <h2 class="mt-5 mb-3">What We Help Women With</h2>

                            <div class="row g-3 mb-4">
                                <div class="col-md-6" data-aos="fade-up">
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            <h3 class="h6 mb-2 text-primary"><i class="bi bi-lightning me-2"></i>Anxiety &amp; Overwhelm</h3>
                                            <p class="small mb-0">Racing thoughts, constant worry, perfectionism, and the mental load of managing everyone's schedules, needs, and emotions. Learn to quiet the noise without dropping the ball.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6" data-aos="fade-up">
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            <h3 class="h6 mb-2 text-primary"><i class="bi bi-cloud-rain me-2"></i>Depression &amp; Mood Changes</h3>
                                            <p class="small mb-0">Persistent sadness, numbness, irritability, or exhaustion — including mood changes tied to hormonal transitions like the postpartum period and perimenopause.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6" data-aos="fade-up">
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            <h3 class="h6 mb-2 text-primary"><i class="bi bi-balloon-heart me-2"></i>Motherhood &amp; Postpartum</h3>
                                            <p class="small mb-0">Postpartum depression and anxiety, birth trauma, fertility struggles, pregnancy loss, and the identity shift of becoming a mother. See our dedicated <a href="postpartum-depression-therapy-michigan">postpartum depression therapy</a> page.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6" data-aos="fade-up">
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            <h3 class="h6 mb-2 text-primary"><i class="bi bi-signpost-split me-2"></i>Life Transitions &amp; Identity</h3>
                                            <p class="small mb-0">Divorce, empty nest, career changes, caregiving for aging parents, and seasons where you no longer recognize yourself. Rediscover who you are beyond your roles.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <h2 class="mt-5 mb-3">Common Concerns We See</h2>
                            ...
                            <h2 class="mt-5 mb-3">For Working Mothers &amp; Professional Women</h2>
                            ...
                            <h2 class="mt-5 mb-3">Our Approach to Women's Mental Health</h2>

                            <div class="card border-0 shadow-sm mb-4" data-aos="fade-up">
                                <div class="card-body">
                                    <h3 class="h6 mb-3">Cognitive Behavioral Therapy (CBT)</h3>
                                    <p class="small mb-4">Challenge the inner critic, perfectionism, and anxious thought spirals with practical, evidence-based tools.</p>

                                    <h3 class="h6 mb-3">Trauma-Informed Care &amp; EMDR</h3>
                                    <p class="small mb-4">Process past experiences — including birth trauma and relationship trauma — at a pace that feels safe.</p>

                                    <h3 class="h6 mb-3">Perinatal Mental Health</h3>
                                    <p class="small mb-4">Specialized treatment for postpartum depression, postpartum anxiety, and mood changes during pregnancy from clinicians trained in perinatal mood and anxiety disorders.</p>

                                    <h3 class="h6 mb-0">Boundary &amp; Identity Work</h3>
                                    <p class="small mb-0">Learn to set boundaries without guilt, ask for support, and reconnect with the person underneath all the roles you play.</p>
                                </div>
                            </div>

                            <h2 class="mt-5 mb-3">Why Michigan Women Choose Us</h2>
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-md-6" data-aos="fade-up">
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            <h3 class="h6 mb-2 text-primary">Benefits Check Before You Start</h3>
                                            <p class="small mb-0">Call (313) 654-1915 and we'll verify your coverage before your first session. Self-pay options are available if you prefer not to use insurance.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="alert alert-primary mt-5" role="alert">
                                <h3 class="alert-heading"><i class="bi bi-telephone-fill me-2"></i>Take One Hour Back for Yourself</h3>
                                <p class="mb-2"><strong>Call (313) 654-1915 to schedule an appointment</strong></p>
                                <p class="mb-2">You spend your days taking care of everyone else. Therapy is where someone takes care of you.</p>
