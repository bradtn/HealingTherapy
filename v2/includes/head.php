 ...
 *
 * While the redesign lives at /v2/, V2_PREVIEW keeps every page
 * noindexed and canonicalized to the production URL so the preview
 * can sit on the live host without duplicate-content risk.
 */
...
<?php endif; ?>
    ...
    <link href="/v2/assets/css/<?php echo V2_PREVIEW ? 'main.css' : 'main.min.css'; ?>?v=<?php echo V2_CSS_VERSION; ?>" rel="stylesheet">
