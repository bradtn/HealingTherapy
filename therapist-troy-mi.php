    ...
    <main class="main">
        <section class="topArea individual position-relative">
            ...
            <div class="position-absolute text-center w-100">
                <div class="display-3 fw-bold text-white">Therapist Troy MI</div>
        ...
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-md-9">
                        <div class="mx-auto">
                            <h1>Licensed Therapist Serving Troy, Michigan</h1>

                            <p class="lead">Healing Therapy Center provides professional mental health services for Troy, MI residents and Oakland County families. Our licensed therapists offer individual therapy, couples counseling, family therapy, and psychological testing with convenient access from Troy via I-75.</p>
                            ...
                            <div class="alert alert-info mb-4" data-aos="fade-up">
                                <h3 class="h5 mb-3"><i class="bi bi-geo-alt-fill me-2"></i>Convenient for Troy Residents</h3>
                                <p class="mb-2"><strong>Office Location:</strong> 835 Mason St STE D160, Dearborn, MI 48124</p>
                                <p class="mb-2"><strong>From Troy:</strong> 25 minutes via I-75 South to I-94 West</p>
                                <p class="mb-2"><strong>Telehealth Option:</strong> Online therapy from your Troy home - same insurance coverage</p>
                                <ul class="mb-0">
                            ...
                            <h2 class="mt-5 mb-3">Mental Health Services for Troy Residents</h2>
                                ...
                                <div class="col-md-6" data-aos="fade-up">
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            ...
                                            <p class="small mb-0">Treatment for anxiety, depression, stress, trauma, grief, and life transitions. We help Troy professionals manage work stress, career transitions, and work-life balance challenges.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6" data-aos="fade-up">
                                ...
                                <div class="col-md-6" data-aos="fade-up">
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            ...
                                            <p class="small mb-0">Family counseling for parenting challenges, teen issues, and family dynamics. Help your Troy family improve communication and resolve conflicts.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6" data-aos="fade-up">
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            <h3 class="h6 mb-2 text-primary"><i class="bi bi-clipboard-data me-2"></i>ADHD & Autism Testing</h3>
                                            <p class="small mb-0">Comprehensive psychological testing for children and adults. ADHD evaluations, autism assessments, and diagnostic testing covered by most insurance plans.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <h2 class="mt-5 mb-3">Common Concerns We Address for Troy Clients</h2>
                            ...
                            <h2 class="mt-5 mb-3">Insurance Accepted for Troy Residents</h2>
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-6" data-aos="fade-up">
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            <h3 class="h6 mb-2 text-primary">Major Insurance Plans</h3>
                                            <ul class="small mb-0">
                                ...
                                <div class="col-md-6" data-aos="fade-up">
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            ...
                                            <p class="small mt-2 mb-0"><strong>Call <a href="tel:313-654-1915">(313) 654-1915</a> to verify your insurance benefits.</strong></p>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <h2 class="mt-5 mb-3">Meet Our Troy-Area Therapists</h2>
                            ...
                            <h2 class="mt-5 mb-3">Why Troy Residents Choose Healing Therapy Center</h2>
                            ...
                            <h2 class="mt-5 mb-3">Telehealth Therapy - Perfect for Troy Professionals</h2>
                            ...
                            <div class="alert alert-primary mt-5" role="alert">
                                ...
                                <p class="mb-2"><strong>Serving Troy, MI & Oakland County</strong></p>
                                <p class="mb-2"><strong>Phone:</strong> <a href="tel:313-654-1915" class="alert-link">(313) 654-1915</a></p>
                                <p class="mb-2"><strong>Office:</strong> 835 Mason St STE D160, Dearborn, MI 48124 (25 min from Troy)</p>
