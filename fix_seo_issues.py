...
def optimize_page_title(content, filename):
    ...
    title_map = {
        ...
        'tiffany-murray.html': 'Tiffany Murray, LLMSW | Therapist | Healing Therapy Center',
        'dr-tiffany-murray.html': 'Dr. Tiffany Murray, LLMSW | Therapist | Healing Therapy Center',
