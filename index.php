          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="card h-100 border-0 shadow-sm text-center">
              <div class="card-body">
                ...
                <h5 class="card-title">Part of Your Community</h5>
        ...
        <div class="row mt-5">
          <div class="col-lg-10 mx-auto">
            <div class="alert alert-primary text-center" role="alert">
              <h5 class="mb-2"><i class="bi bi-heart-fill me-2"></i>Small Practice, Big Impact</h5>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6">
            <div class="alert alert-info">
              <h5 class="alert-heading"><i class="bi bi-laptop me-2"></i>Telehealth Benefits</h5>
              <ul class="mb-0">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100 border-0 shadow-sm">
              <div class="card-body text-center">
                ...
                <h5 class="card-title mt-3">Licensed Michigan Therapists</h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100 border-0 shadow-sm">
              <div class="card-body text-center">
                ...
                <h5 class="card-title mt-3">Telehealth & In-Person Options</h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100 border-0 shadow-sm">
              <div class="card-body text-center">
                ...
                <h5 class="card-title mt-3">Specialized Expertise</h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100 border-0 shadow-sm">
              <div class="card-body text-center">
                ...
                <h5 class="card-title mt-3">Culturally Sensitive Care</h5>
