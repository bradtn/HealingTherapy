            ...
            <a href="therapists" class="text-decoration-none">
              <div class="card h-100 border-0 shadow-sm text-center">
                <div class="card-body">
                  ...
                  <h4 class="card-title h5">Same Therapist Every Session</h4>
            ...
            <a href="appointment" class="text-decoration-none">
              <div class="card h-100 border-0 shadow-sm text-center">
                <div class="card-body">
                  ...
                  <h4 class="card-title h5">In-Person or Telehealth</h4>
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="card h-100 border-0 shadow-sm text-center">
              <div class="card-body">
                ...
                <h4 class="card-title h5">Insurance Accepted</h4>
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="card h-100 border-0 shadow-sm text-center">
              <div class="card-body">
                ...
                <h4 class="card-title h5">Part of Your Community</h4>
        ...
        <div class="row mt-5">
          <div class="col-lg-10 mx-auto">
            <div class="alert alert-primary text-center" role="alert">
              <h4 class="mb-2 h5"><i class="bi bi-heart-fill me-2"></i>Small Practice, Big Impact</h4>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6">
            <div class="alert alert-info">
              <h4 class="alert-heading h5"><i class="bi bi-laptop me-2"></i>Telehealth Benefits</h4>
              <ul class="mb-0">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100 border-0 shadow-sm">
              <div class="card-body text-center">
                ...
                <h4 class="card-title mt-3 h5">Licensed Michigan Therapists</h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100 border-0 shadow-sm">
              <div class="card-body text-center">
                ...
                <h4 class="card-title mt-3 h5">Telehealth & In-Person Options</h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100 border-0 shadow-sm">
              <div class="card-body text-center">
                ...
                <h4 class="card-title mt-3 h5">Major Insurance Plans</h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100 border-0 shadow-sm">
              <div class="card-body text-center">
                ...
                <h4 class="card-title mt-3 h5">Specialized Expertise</h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100 border-0 shadow-sm">
              <div class="card-body text-center">
                ...
                <h4 class="card-title mt-3 h5">Flexible Scheduling</h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100 border-0 shadow-sm">
              <div class="card-body text-center">
                ...
                <h4 class="card-title mt-3 h5">Culturally Sensitive Care</h4>
