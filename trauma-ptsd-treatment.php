        ...
        <div class="col-12 mb-3" data-aos="fade-up" data-aos-delay="400">
            <div class="card border-0 shadow-sm h-100 faq-card">
                <div class="card-body">
                    ...
                    <p class="card-text text-muted mb-0">Most Michigan insurance plans cover PTSD and trauma treatment. We accept BCBS, McLaren, Priority Health, Aetna, and Michigan Medicaid. Call (313) 654-1915 to verify coverage.</p>
                </div>
            </div>
        </div>
    </div>
