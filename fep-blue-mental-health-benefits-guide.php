...
<main id="main">
    ...
    $hero_h1 = 'Your Complete Guide to FEP Blue Mental Health Benefits for Federal Employees in Michigan (2026)';
    $hero_lead = "As a federal employee working for USPS, CBP, FBI, VA, or any other federal agency in Michigan, you have access to some of the best mental health insurance benefits available through FEP Blue (Blue Cross Blue Shield Federal Employee Program). Yet many federal employees don't fully understand their mental health coverage or how to use it effectively.";
        ...
        <div class="shell">
            <article class="prose">
                ...
                <div class="callout callout--info">
                    <h3>Verify Your Specific Costs</h3>
                    <p>Coverage, copays, deductibles, and coinsurance vary by FEP Blue plan and year. Before scheduling, call your therapist's office or FEP Blue directly to verify your exact out-of-pocket costs for mental health services.</p>
                </div>
