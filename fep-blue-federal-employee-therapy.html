...
$page_title = 'FEP Blue Therapist Michigan | Federal Employee Mental Health Services';
                    ...
                    <div class="col-md-9">
                        <div class="mx-auto">
                            ...
                            <div class="alert alert-success mb-4" data-aos="fade-up">
                                ...
                                <ul class="mb-0">
                                    <li>Low co-pays (typically $15-$30 per session)</li>
                                    <li>No pre-authorization required for most services</li>
                                    <li>Comprehensive coverage for individual, couples, and family therapy</li>
                                    <li>Coverage for psychological testing (ADHD, autism evaluations)</li>
                            ...
                            <div class="card border-0 shadow-sm mb-4" data-aos="fade-up">
                                <div class="card-body">
                                    ...
                                    <p class="mt-3 mb-0"><strong>Typical Co-Pay:</strong> $15-$30 per session (varies by plan option - Standard or Basic). <strong>Call us at <a href="tel:313-654-1915">(313) 654-1915</a> to verify your specific benefits.</strong></p>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6" data-aos="fade-up" data-aos-delay="0">
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            ...
                                            <p class="small mb-0">We accept FEP Blue insurance - no surprise bills, low co-pays, comprehensive coverage. We handle all billing and verification.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div class="card border-0 shadow-sm mb-4" data-aos="fade-up">
                                <div class="card-body">
                                    ...
                                    <ol class="small mb-0">
                                        <li class="mb-3"><strong>Call us at (313) 654-1915</strong> - We'll verify your FEP Blue coverage, explain your co-pay, and answer any questions about benefits.</li>
                                        <li class="mb-3"><strong>No pre-authorization needed</strong> - For most outpatient mental health services, FEP Blue does not require pre-authorization. You can start therapy right away.</li>
                                        ...
                                        <li class="mb-3"><strong>Pay only your co-pay</strong> - Typically $15-$30 per session depending on whether you have FEP Blue Standard or Basic. No surprise bills.</li>
                            ...
                            <div class="alert alert-info mb-4" data-aos="fade-up">
                                <p class="mb-2"><i class="bi bi-info-circle-fill me-2"></i><strong>What's Covered by FEP Blue?</strong></p>
                                <ul class="small mb-0">
                                    <li><strong>Outpatient therapy:</strong> Unlimited sessions per year (with co-pay)</li>
                                    <li><strong>Psychological testing:</strong> Covered for diagnostic purposes (ADHD, autism, etc.)</li>
                                    <li><strong>Telehealth:</strong> Same coverage as in-person visits</li>
                                    <li><strong>Family members:</strong> Your dependents on FEP Blue are also covered</li>
                                    <li><strong>No deductible:</strong> Mental health visits typically don't require meeting your deductible first</li>
                                </ul>
                            </div>
                                    ...
                                    <div class="col-12 mb-3" data-aos="fade-up" data-aos-delay="0">
                                        <div class="card border-0 shadow-sm h-100 faq-card">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text text-muted mb-0">Yes! FEP Blue (Blue Cross Blue Shield Federal Employee Program) provides excellent mental health coverage throughout Michigan. Your plan covers individual therapy, couples therapy, family therapy, and psychological testing with just a small co-pay per session (typically $15-$30). We are an in-network provider, so you get the maximum benefit with no surprise bills. Both in-person and telehealth sessions are covered equally.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 mb-3" data-aos="fade-up" data-aos-delay="100">
                                        <div class="card border-0 shadow-sm h-100 faq-card">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text text-muted mb-0">No! FEP Blue does not require a referral for mental health services. You can call us directly at (313) 654-1915 to schedule an appointment. This is one of the great benefits of the Federal Employee Program - direct access to mental health care without bureaucratic delays. You can start therapy as soon as we have an appointment available.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 mb-3" data-aos="fade-up" data-aos-delay="200">
                                        <div class="card border-0 shadow-sm h-100 faq-card">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text text-muted mb-0">FEP Blue co-pays for mental health visits are typically $15-$30 per session, depending on whether you have FEP Blue Standard ($15-$25 co-pay) or FEP Blue Basic ($25-$30 co-pay). This is significantly lower than many private insurance plans. There's no deductible to meet for mental health services, and no limit on the number of sessions per year. Call us to verify your specific co-pay amount based on your plan.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 mb-3" data-aos="fade-up" data-aos-delay="400">
                                        <div class="card border-0 shadow-sm h-100 faq-card">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text text-muted mb-0">Yes! We offer secure, HIPAA-compliant telehealth therapy for federal employees anywhere in Michigan. This is perfect if you work irregular hours, have a long commute, work from home, or simply prefer the convenience of online sessions. FEP Blue covers telehealth the same as in-person visits - same co-pay, same benefits. Many federal employees prefer telehealth because they can attend therapy during lunch breaks or from the privacy of their home.</p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="alert alert-success mt-3" role="alert">
                                ...
                                <p class="mb-0">We accept Blue Cross Blue Shield Federal Employee Program (FEP Blue) insurance for all federal civilian employees. Low co-pays ($15-$30), no pre-authorization required, comprehensive mental health coverage. Serving USPS, CBP, FBI, VA, and all federal employees in Michigan. Call <a href="tel:313-654-1915" class="alert-link">(313) 654-1915</a> to verify your benefits and schedule an appointment today.</p>
                            </div>
