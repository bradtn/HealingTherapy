                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch justify-content-center text-center"
                        ...
                        <div class="team-member">
                            <div class="member-img rounded-circle border border-4 border-primary" style="width: 300px; height: 300px; max-width: 100%;">
                                <img src="assets/img/tiffany.jpg" class="img-fluid rounded-circle p-3 doc-pic" alt="tiffany murray" style="width: 100%; height: 100%; object-fit: cover;">
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        <h2>Schedule a Session with Tiffany</h2>
                        <p class="mb-4">Whether you are navigating the challenges of new parenthood, coping with grief, or seeking support for life transitions, Tiffany provides compassionate, trauma-informed care. Contact us today to schedule your consultation.</p>
