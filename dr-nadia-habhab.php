            ...
            <div class="container-fluid">
                ...
                <div class="row gy-4 justify-content-center align-items-center">
                    ...
                    <div class="col-lg-8 col-md-8"
                        ...
                        <p>I draw from attachment-based and emotion-focused approaches to help you make sense of your experiences and create meaningful change. I'm trained in both Emotion-Focused Therapy (EFT), EMDR (Eye Movement Desensitization and Reprocessing), Cognitive Behavioral Therapy (CBT), and Trauma Informed approaches, and I tailor each session to you and your experiences. I hold certification in emotion focused individual therapy (EFIT), CBT, EMDR, and experience in providing trauma informed care. I am trained in the Gottman method and have experience with trauma survivors, first responders and complex PTSD.</p>
