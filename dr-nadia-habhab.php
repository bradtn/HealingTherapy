...
<body class="index-page">
    ...
    <main class="main">
        ...
        <section id="recent-blog-posts" class="about section">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <h2 class="text-center mb-4">Recent Blog Posts by Dr. Habhab</h2>
                        <div class="row g-4">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img src="assets/img/blog-8.jpg" class="img-fluid rounded-start h-100 object-fit-cover" alt="person first approach therapy">
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body">
