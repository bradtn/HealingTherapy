    ...
    <main class="main">
        <section class="topArea individual position-relative">
            ...
            <div class="position-absolute text-center w-100">
                <div class="display-3 fw-bold text-white">Postpartum Depression Therapy Michigan</div>
        ...
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-md-9">
                        <div class="mx-auto">
                            <h1>Postpartum Depression &amp; Anxiety Treatment for Michigan Moms</h1>

                            <p class="lead">If motherhood doesn't feel the way you expected it to, you are not alone and you are not failing. Healing Therapy Center provides specialized treatment for postpartum depression, postpartum anxiety, and other perinatal mood disorders — in person at our Dearborn office or by secure telehealth anywhere in Michigan.</p>
                            ...
                            <div class="alert alert-success mb-4" data-aos="fade-up">
                                <h3 class="h5 mb-3"><i class="bi bi-heart-fill me-2"></i>Specialized Care for New Mothers</h3>
                                <ul class="mb-2">
                                ...
                                <p class="small mb-0"><strong>Call <a href="tel:313-654-1915" class="alert-link">(313) 654-1915</a></strong> — you don't have to wait until it gets worse.</p>
                            </div>

                            <h2 class="mt-5 mb-3">Postpartum Conditions We Treat</h2>
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-6" data-aos="fade-up">
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            <h3 class="h6 mb-2 text-primary"><i class="bi bi-cloud-rain me-2"></i>Postpartum Depression (PPD)</h3>
                                            <p class="small mb-0">Persistent sadness, numbness, guilt, hopelessness, or difficulty bonding with your baby that lasts beyond the first two weeks. PPD can begin any time in the first year after birth.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6" data-aos="fade-up">
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            <h3 class="h6 mb-2 text-primary"><i class="bi bi-lightning me-2"></i>Postpartum Anxiety &amp; OCD</h3>
                                            <p class="small mb-0">Constant worry, racing thoughts, inability to sleep even when the baby sleeps, and scary intrusive thoughts. Intrusive thoughts are common, treatable, and do not mean you are a danger to your baby.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6" data-aos="fade-up">
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            <h3 class="h6 mb-2 text-primary"><i class="bi bi-bandaid me-2"></i>Birth Trauma &amp; PTSD</h3>
                                            <p class="small mb-0">Flashbacks, nightmares, or intense distress after a difficult delivery, emergency intervention, or NICU stay. Trauma-focused therapy helps you process what happened.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6" data-aos="fade-up">
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            <h3 class="h6 mb-2 text-primary"><i class="bi bi-emoji-frown me-2"></i>Postpartum Rage &amp; Overwhelm</h3>
                                            <p class="small mb-0">Irritability, anger outbursts, and resentment that feel out of character. Rage is a common but rarely discussed symptom of perinatal mood disorders.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <h2 class="mt-5 mb-3">More Than the Baby Blues: When to Seek Help</h2>
                            ...
                            <div class="alert alert-warning" role="alert">
                                <p class="small mb-0"><strong>If you are in crisis or having thoughts of harming yourself or your baby, get help now:</strong> call or text the <strong>988 Suicide &amp; Crisis Lifeline</strong>, or call the free, 24/7 <strong>National Maternal Mental Health Hotline at 1-833-852-6262 (1-833-TLC-MAMA)</strong>.</p>
                            </div>

                            <h2 class="mt-5 mb-3">How We Treat Postpartum Depression &amp; Anxiety</h2>
                            ...
                            <div class="card border-0 shadow-sm mb-4" data-aos="fade-up">
                                <div class="card-body">
                                    ...
                                    <p class="small mb-4">A first-line treatment for PPD and postpartum anxiety. Identify and change the thought patterns fueling guilt, worry, and hopelessness — with practical tools you can use between sessions.</p>

                                    <h3 class="h6 mb-3">Trauma-Focused Therapy</h3>
                                    <p class="small mb-4">For birth trauma and pregnancy loss, we use trauma-informed approaches including EMDR to help you process difficult experiences safely.</p>

                                    <h3 class="h6 mb-3">Support for Identity &amp; Relationship Changes</h3>
                                    <p class="small mb-4">Motherhood changes your identity, your body, and your relationships. Therapy provides space to process matrescence, partner conflict, and the loss of your pre-baby self.</p>

                                    <h3 class="h6 mb-0">Coordination With Your Care Team</h3>
                                    <p class="small mb-0">With your consent, we can coordinate with your OB-GYN, midwife, or primary care provider to make sure your care is connected.</p>
                                </div>
                            </div>

                            <h2 class="mt-5 mb-3">Why Michigan Moms Choose Healing Therapy Center</h2>
                            ...
                            <h2 class="mt-5 mb-3">Insurance &amp; Payment</h2>
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-md-6" data-aos="fade-up">
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            <h3 class="h6 mb-2 text-primary">Not Sure About Coverage?</h3>
                                            <p class="small mb-0">Call us at (313) 654-1915 and we'll verify your benefits before your first appointment, so there are no surprises. Self-pay options are also available.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <h2 class="mt-5 mb-3">Telehealth Postpartum Therapy Across Michigan</h2>
                            ...
                            <div class="alert alert-primary mt-5" role="alert">
                                <h3 class="alert-heading"><i class="bi bi-telephone-fill me-2"></i>You Deserve to Feel Like Yourself Again</h3>
                                <p class="mb-2"><strong>Call (313) 654-1915 to schedule with a perinatal-trained therapist</strong></p>
                                <p class="mb-2">Postpartum depression and anxiety are highly treatable. Most moms start feeling better within weeks of beginning therapy.</p>
                                <p class="mb-0"><strong>Telehealth available throughout Michigan</strong> | In-person care in Dearborn | Insurance accepted</p>
                            </div>
