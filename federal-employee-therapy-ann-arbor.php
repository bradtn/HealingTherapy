    ...
    <main class="main">
        <section class="topArea individual position-relative">
            ...
            <div class="position-absolute text-center w-100">
                <div class="display-3 fw-bold text-white">Therapy for Federal Employees in Ann Arbor</div>
        ...
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-md-9">
                        <div class="mx-auto">
                            <h1>Therapist for Federal Employees in Ann Arbor, Michigan</h1>

                            <p class="lead">Federal employee in Ann Arbor looking for mental health support? Healing Therapy Center provides therapy services for federal employees throughout Washtenaw County using FEP Blue (Blue Cross Blue Shield Federal Employee Program) insurance.</p>
                            ...
                            <div class="alert alert-info mb-4" data-aos="fade-up">
                                <h3 class="h5 mb-3"><i class="bi bi-geo-alt-fill me-2"></i>Serving Ann Arbor Federal Employees</h3>
                                <p class="mb-2"><strong>Telehealth:</strong> Most convenient option for Ann Arbor residents</p>
                                <p class="mb-2"><strong>In-Person:</strong> 40 minutes from Ann Arbor (Dearborn office via I-94)</p>
                                <ul class="mb-0">
                            ...
                            <h2 class="mt-5 mb-3">Federal Employees We Serve in Ann Arbor Area</h2>

                            <div class="row g-3 mb-4">
                                <div class="col-md-6" data-aos="fade-up">
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            <h3 class="h6 mb-2 text-primary">VA Ann Arbor Healthcare System</h3>
                                            <ul class="small mb-0">
                                ...
                                <div class="col-md-6" data-aos="fade-up">
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            <h3 class="h6 mb-2 text-primary">Federal Research & University Staff</h3>
                                            <ul class="small mb-0">
                                ...
                                <div class="col-md-6" data-aos="fade-up">
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            <h3 class="h6 mb-2 text-primary">USPS Ann Arbor</h3>
                                            <ul class="small mb-0">
                                ...
                                <div class="col-md-6" data-aos="fade-up">
                                    <div class="card h-100 border-0 shadow-sm">
                                        <div class="card-body">
                                            <h3 class="h6 mb-2 text-primary">Other Federal Employees</h3>
                                            <ul class="small mb-0">
                            ...
                            <div class="alert alert-success mb-4" data-aos="fade-up">
                                <h3 class="h6 mb-3"><i class="bi bi-check-circle-fill me-2"></i>Mental Health Services for Ann Arbor Federal Employees</h3>
                                <ul class="small mb-0">
                                ...
                                <p class="small mt-2 mb-0"><strong>Important:</strong> Coverage varies by plan. Call <a href="tel:313-654-1915" class="alert-link">(313) 654-1915</a> to verify your FEP Blue benefits. <a href="fep-blue-federal-employee-therapy" class="alert-link">Learn more</a>.</p>
                            </div>

                            <h2 class="mt-5 mb-3">Mental Health Challenges for Ann Arbor Federal Workers</h2>
                            ...
                            <h2 class="mt-5 mb-3">Telehealth Therapy - Ideal for Ann Arbor</h2>
                            ...
                            <h2 class="mt-5 mb-3">Why Ann Arbor Federal Employees Choose Us</h2>
                            ...
                            <div class="alert alert-primary mt-5" role="alert">
                                ...
                                <p class="mb-2"><strong>Serving Ann Arbor Federal Employees</strong></p>
                                <p class="mb-2"><strong>Phone:</strong> <a href="tel:313-654-1915" class="alert-link">(313) 654-1915</a></p>
                                <p class="mb-2"><strong>Telehealth:</strong> Secure online therapy from your Ann Arbor home</p>
                                <p class="mb-2"><strong>In-Person:</strong> 835 Mason St STE D160, Dearborn, MI 48124 (40 min via I-94)</p>
                                <p class="mb-0">We accept FEP Blue for all federal employees in Ann Arbor and Washtenaw County.</p>
                            </div>
