    ...
    <main class="main">
        ...
        <section class="topArea telehealth position-relative">
            ...
            <div class="position-absolute text-center w-100">
                <div class="display-3 fw-bold text-white">Telehealth Therapy</div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <h5 class="fw-bold">What is Individual Therapy?</h5>
                        ...
                        <h5 class="fw-bold mt-4">Benefits of Telehealth Therapy</h5>
